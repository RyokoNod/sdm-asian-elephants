...
if (normalize==TRUE){
  pres_preds_file <-  paste(resultfolder,'results_present_slinGLM_norm',feature_type,'_seed', random_seed, 
                            '.csv',sep='')
}else{
  pres_preds_file <-  paste(resultfolder,'results_present_slinGLM_',feature_type,'_seed', random_seed, 
                            '.csv',sep='')
}
